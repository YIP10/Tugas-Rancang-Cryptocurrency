...
public class AllCryptosActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Top Cryptocurrency");
        ...
        String url = BASE_URL + "/data/top/mktcapfull?limit=50&tsym=IDR";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i=0; i < js.length(); i++) {
                        JSONObject display = js.getJSONObject(i).getJSONObject("DISPLAY").getJSONObject("IDR");
    ...
    public void onClick(View view) {
        if (view == itemAll){
            ...
            Intent i = new Intent(AllCryptosActivity.this, AboutActivity.class);
            startActivity(i);

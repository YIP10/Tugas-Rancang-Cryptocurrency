...
public class CurrencyDetailsFragment extends Fragment {
    ...
    TextView price, changePCT, algorithm, market, title;
    ImageView image, backArrow;

    TextView lowPrice, highPrice, openPrice;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = BASE_URL + "/data/pricemultifull?fsyms=" + data.get(0) + "&tsyms=IDR";
        //Log.i("*****", url);
    ...
    private void prepareCurrencies(String url) {
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONObject display = response.getJSONObject("DISPLAY").getJSONObject(data.get(0)).getJSONObject("IDR");
    ...
    private void plotGraph() {
        ...
        String graphURL = BASE_URL + "/data/histoday?fsym="+ data.get(0) + "&tsym=IDR&limit=7";
